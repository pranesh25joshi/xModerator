...
<details>
<summary><strong>🔧 Install from Source Code</strong></summary>
...
git clone https://github.com/pranesh25joshi/xmoderator.git
cd xmoderator

# Or download ZIP directly
# https://github.com/pranesh25joshi/xmoderator/archive/main.zip
```

**Then follow steps 2-3 from Quick Install above**

</details>

<details>
<summary><strong>🌟 Beta/Development Versions</strong></summary>

Access cutting-edge features:
- Go to [Releases](https://github.com/pranesh25joshi/xmoderator/releases)
- Look for "Pre-release" tags
- Download and install following the same process
...
3. Verify all categories work correctly
4. Test settings import/export
5. Check performance with large feeds
...
- **CSS**: Modern CSS3, CSS Grid/Flexbox
...
**Problem**: Extension icon shows but content isn't filtered
```
✅ Solutions:
1. Refresh the X/Twitter page
...
**Problem**: Some unwanted content still appears
```
✅ Solutions:
1. Increase sensitivity level (Settings → General → High)
2. Add custom keywords for specific content
3. Enable more categories in popup
4. Report missed content as an issue
```
...
4. Include console output when reporting issues

### Reset Extension
```bash
# Complete reset process:
1. Go to chrome://extensions/
2. Find xModerator → Remove
3. Restart browser
4. Reinstall from latest release
```

### Compatibility Issues
- **Twitter/X Layout Changes**: May require extension update
- **Browser Updates**: Check compatibility with your browser version
- **Other Extensions**: Disable other Twitter extensions temporarily
